...
export const TEMPLATES: SiteTemplate[] = [
  ...
  },
  {
    ...
    brand: kit({
      colors: {
        primary: '#075985', secondary: '#1e3a8a', accent: '#f59e0b',
  ...
  },
  {
    id: 'tidewater',
    layout: 'banded',
    treatments: ['glass', 'circle-mask', 'reveal', 'italic-display'],
    name: 'Tidewater',
    tagline: 'Coastal and unhurried, for places that sell calm.',
    industries: ['hospitality', 'health', 'generic'],
    tags: ['calm', 'airy', 'light'],
    brand: kit({
      colors: {
        primary: '#0e7490', secondary: '#164e63', accent: '#f0abfc',
        background: '#f7fbfc', surface: '#e6f2f5', text: '#0c2028',
        textMuted: '#4a6b76', border: '#c9e0e6',
      },
      type: {
        headingFamily: SERIF_SHARP, bodyFamily: SANS_GEO, ratio: 1.26,
        baseSizePx: 18, headingWeight: 500, headingLineHeight: 1.1, letterSpacing: '-0.012em',
      },
      shape: (b) => PILL(b, '14 116 144'),
      imageStyle: ['bright', 'natural'],
    }),
    hero: { layout: 'centered', height: 'large', overlay: 'none' },
    animation: 'fade',
    homeSections: ['hero', 'services', 'gallery', 'testimonials', 'stats', 'cta'],
  },
  {
    id: 'foundry',
    layout: 'canvas',
    treatments: ['outline-type', 'stripes', 'mask-wipe', 'big-numerals'],
    name: 'Foundry',
    tagline: 'Industrial and loud. Built for firms that make physical things.',
    industries: ['trades', 'automotive', 'retail'],
    tags: ['bold', 'industrial', 'high-contrast'],
    brand: kit({
      colors: {
        primary: '#dc2626', secondary: '#171717', accent: '#facc15',
        background: '#fafafa', surface: '#ededed', text: '#0a0a0a',
        textMuted: '#525252', border: '#d4d4d4',
      },
      type: {
        headingFamily: SANS_GROTESK, bodyFamily: SANS_SYSTEM, ratio: 1.46,
        baseSizePx: 17, headingWeight: 900, headingLineHeight: .96, letterSpacing: '-0.035em',
      },
      shape: SQUARE,
      imageStyle: ['architectural', 'documentary'],
    }),
    hero: { layout: 'left', height: 'viewport', overlay: 'none' },
    animation: 'slide-up',
    homeSections: ['hero', 'stats', 'services', 'gallery', 'logo_cloud', 'cta'],
  },
  {
    id: 'almanac',
    layout: 'magazine',
    treatments: ['dot-grid', 'pull-quote', 'drop-cap', 'corner-marks'],
    name: 'Almanac',
    tagline: 'Reference-book density, for organisations with a lot to say.',
    industries: ['nonprofit', 'education', 'professional_services'],
    tags: ['editorial', 'dense', 'text-first'],
    brand: kit({
      colors: {
        primary: '#7c3aed', secondary: '#3b0764', accent: '#16a34a',
        background: '#fdfcfb', surface: '#f4f1ec', text: '#1c1917',
        textMuted: '#57534e', border: '#dcd5ca',
      },
      type: {
        headingFamily: SERIF_CLASSIC, bodyFamily: SERIF_BOOK, ratio: 1.22,
        baseSizePx: 17, headingWeight: 700, headingLineHeight: 1.16, letterSpacing: '0',
      },
      shape: CRISP,
      imageStyle: ['documentary', 'editorial'],
    }),
    hero: { layout: 'left', height: 'small', overlay: 'none' },
    animation: 'none',
    homeSections: ['hero', 'text', 'services', 'stats', 'faq', 'cta'],
  },
  {
    id: 'verdant',
    layout: 'editorial',
    treatments: ['circle-mask', 'italic-display', 'stagger', 'marquee'],
    name: 'Verdant',
    tagline: 'Botanical and gentle, for growers, gardens and slow trades.',
    industries: ['retail', 'hospitality', 'nonprofit'],
    tags: ['natural', 'soft', 'organic'],
    brand: kit({
      colors: {
        primary: '#3f6212', secondary: '#1a2e05', accent: '#ea580c',
        background: '#fcfdf7', surface: '#eef4e2', text: '#1a2410',
        textMuted: '#55663f', border: '#d5e3bf',
      },
      type: {
        headingFamily: SERIF_CLASSIC, bodyFamily: SANS_GEO, ratio: 1.3,
        baseSizePx: 18, headingWeight: 500, headingLineHeight: 1.08, letterSpacing: '-0.015em',
      },
      shape: (b) => SOFT(b, '77 124 15'),
      imageStyle: ['natural', 'bright'],
    }),
    hero: { layout: 'split', height: 'large', overlay: 'none' },
    animation: 'fade',
    homeSections: ['hero', 'text_image', 'gallery', 'services', 'logo_cloud', 'cta'],
  },
  {
    id: 'beacon',
    layout: 'cards',
    treatments: ['glass', 'tilt', 'gradient-wash', 'arrow-links'],
    name: 'Beacon',
    tagline: 'Product-led and confident, for software and modern services.',
    industries: ['professional_services', 'generic', 'education'],
    tags: ['modern', 'vivid', 'product'],
    brand: kit({
      colors: {
        primary: '#4f46e5', secondary: '#1e1b4b', accent: '#06b6d4',
        background: '#ffffff', surface: '#f1f2fd', text: '#111827',
        textMuted: '#4b5563', border: '#dcdff5',
      },
      type: {
        headingFamily: SANS_UI, bodyFamily: SANS_UI, ratio: 1.32,
        baseSizePx: 17, headingWeight: 700, headingLineHeight: 1.06, letterSpacing: '-0.025em',
      },
      shape: (b) => SOFT(b, '79 70 229'),
      imageStyle: ['bright', 'minimal'],
    }),
    hero: { layout: 'centered', height: 'large', overlay: 'none' },
    animation: 'fade',
    homeSections: ['hero', 'services', 'stats', 'pricing', 'testimonials', 'cta'],
  },
  {
    id: 'slate-co',
    layout: 'rail',
    treatments: ['corner-marks', 'ruled', 'underline', 'reveal'],
    name: 'Slate & Co',
    tagline: 'Sober and precise, for advice people pay a retainer for.',
    industries: ['professional_services', 'real_estate', 'generic'],
    tags: ['corporate', 'restrained', 'structured'],
    brand: kit({
      colors: {
        primary: '#334155', secondary: '#0f172a', accent: '#b45309',
        background: '#ffffff', surface: '#f6f7f9', text: '#0f172a',
        textMuted: '#475569', border: '#dde2e8',
      },
      type: {
        headingFamily: SERIF_SHARP, bodyFamily: SANS_SYSTEM, ratio: 1.2,
        baseSizePx: 16, headingWeight: 600, headingLineHeight: 1.2, letterSpacing: '0',
      },
      shape: CRISP,
      imageStyle: ['architectural', 'minimal'],
    }),
    hero: { layout: 'left', height: 'small', overlay: 'none' },
    animation: 'none',
    homeSections: ['hero', 'services', 'team', 'faq', 'contact', 'cta'],
  },
  {
    id: 'sunroom',
    layout: 'masonry',
    treatments: ['polaroid', 'arch', 'stagger', 'drop-cap'],
    name: 'Sunroom',
    tagline: 'Domestic and sunlit, for work that happens inside people homes.',
    industries: ['trades', 'real_estate', 'retail'],
    tags: ['warm', 'friendly', 'homely'],
    brand: kit({
      colors: {
        primary: '#c2410c', secondary: '#7c2d12', accent: '#0d9488',
        background: '#fffaf3', surface: '#fdefdf', text: '#2c1a0e',
        textMuted: '#7a5b44', border: '#f0dcc4',
      },
      type: {
        headingFamily: SERIF_BOOK, bodyFamily: SANS_GEO, ratio: 1.27,
        baseSizePx: 18, headingWeight: 600, headingLineHeight: 1.12, letterSpacing: '-0.01em',
      },
      shape: (b) => SOFT(b, '194 65 12'),
      imageStyle: ['warm', 'natural'],
    }),
    hero: { layout: 'left', height: 'medium', overlay: 'none' },
    animation: 'fade',
    homeSections: ['hero', 'gallery', 'services', 'testimonials', 'team', 'cta'],
  },
  {
    id: 'vector',
    layout: 'offset',
    treatments: ['dot-grid', 'arrow-links', 'mask-wipe', 'display-caps'],
    name: 'Vector',
    tagline: 'Diagrammatic and exact, for technical work sold on precision.',
    industries: ['professional_services', 'automotive', 'trades'],
    tags: ['technical', 'mono', 'precise'],
    brand: kit({
      colors: {
        primary: '#0891b2', secondary: '#0f172a', accent: '#f43f5e',
        background: '#fbfdfe', surface: '#eef6f9', text: '#0b1620',
        textMuted: '#47606e', border: '#cfe2ea',
      },
      type: {
        headingFamily: MONO, bodyFamily: SANS_SYSTEM, ratio: 1.24,
        baseSizePx: 16, headingWeight: 600, headingLineHeight: 1.14, letterSpacing: '-0.005em',
      },
      shape: SQUARE,
      imageStyle: ['minimal', 'architectural'],
    }),
    hero: { layout: 'left', height: 'medium', overlay: 'none' },
    animation: 'none',
    homeSections: ['hero', 'services', 'stats', 'faq', 'logo_cloud', 'cta'],
  },
  {
    id: 'ember',
    layout: 'showcase',
    treatments: ['big-numerals', 'sticky-stack', 'duotone', 'quote-marks'],
    name: 'Ember',
    tagline: 'Low light and appetite, for evening trade and hospitality.',
    industries: ['restaurant', 'hospitality', 'events'],
    tags: ['dark', 'moody', 'luxury'],
    brand: kit({
      colors: {
        primary: '#f97316', secondary: '#0c0a09', accent: '#fbbf24',
        background: '#12100e', surface: '#1e1a17', text: '#f5f0ea',
        textMuted: '#b0a498', border: '#3a322c',
      },
      type: {
        headingFamily: SERIF_CLASSIC, bodyFamily: SANS_GEO, ratio: 1.38,
        baseSizePx: 17, headingWeight: 600, headingLineHeight: 1.04, letterSpacing: '-0.02em',
      },
      shape: (b) => CRISP(b),
    ...
    hero: { layout: 'full_bleed', height: 'viewport', overlay: 'gradient' },
    animation: 'fade',
    homeSections: ['hero', 'text_image', 'stats', 'gallery', 'testimonials', 'cta'],
  },
  {
    id: 'cadence',
    layout: 'banded',
    treatments: ['stripes', 'big-numerals', 'tilt', 'display-caps'],
    name: 'Cadence',
    tagline: 'High-energy and direct, for training, classes and memberships.',
    industries: ['fitness', 'health', 'events'],
    tags: ['energetic', 'vivid', 'bold'],
    brand: kit({
      colors: {
        primary: '#be185d', secondary: '#111827', accent: '#22d3ee',
        background: '#ffffff', surface: '#f4f0ff', text: '#12111a',
        textMuted: '#4b4859', border: '#e0d8fb',
      },
      type: {
        headingFamily: SANS_GROTESK, bodyFamily: SANS_UI, ratio: 1.4,
        baseSizePx: 17, headingWeight: 800, headingLineHeight: .99, letterSpacing: '-0.03em',
      },
      shape: (b) => PILL(b, '124 58 237'),
      imageStyle: ['playful', 'bright'],
    }),
    hero: { layout: 'centered', height: 'large', overlay: 'none' },
    animation: 'zoom',
    homeSections: ['hero', 'stats', 'pricing', 'services', 'testimonials', 'cta'],
  },
];
